...
/*
根据操作码创建具体字节码指令，是一个字节码工厂
*/

// TODO 字节码工厂需要补充

// 无操作数单指令(这些指令都是instructions/constants包下面的)
var (
	nop = &NOP{}
	// push null/int/long/float/double
	...
	// 从局部变量表中的局部变量int/long/float/double/reference 到操作数栈
	iload_0 = &ILOAD_0{}
	iload_1 = &ILOAD_1{}
	iload_2 = &ILOAD_2{}
	iload_3 = &ILOAD_3{}
	...
	// int/long/float/double/reference 类型数据从操作数栈中弹出数据，存放中局部变量表中
	istore_0 = &ISTORE_0{}
	istore_1 = &ISTORE_1{}
	istore_2 = &ISTORE_2{}
	istore_3 = &ISTORE_3{}
